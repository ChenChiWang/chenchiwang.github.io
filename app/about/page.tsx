  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem', position: 'relative', zIndex: 1 }}>
        ...
        >
          <SkillCard title="Programming" icon="⚡" color="#f0883e" items={['Python (Advanced)', 'SQL', 'HTML / JavaScript', 'Shell Script']} />
          <SkillCard title="Data & Tools" icon="📊" color="#58a6ff" items={['Pyplot / Matplotlib', 'Tableau', 'Data Mining', 'Dashboard']} />
          <SkillCard title="Platforms" icon="🖥️" color="#3fb950" items={['Linux (Ubuntu)', 'macOS', 'Windows']} />
          <SkillCard title="Languages" icon="🌍" color="#cba6f7" items={['Chinese 🇹🇼 Native', 'English Proficient', 'Deutsch A1→B1 Learning']} />
        </div>
